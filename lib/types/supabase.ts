  ...
  public: {
    Tables: {
      ...
      orders: {
        ...
        Insert: { billing_address_id?: string | null; cancelled_at?: string | null; cancelled_reason?: string | null; created_at?: string | null; discount_cents?: number | null; edited_at?: string | null; email: string; fulfillment_status?: string; id?: string; notes?: string | null; order_number: string; payhere_payment_id?: string | null; payment_method?: string | null; payment_status?: string | null; shipping_address_id?: string | null; shipping_cents?: number | null; status?: string | null; subtotal_cents: number; tax_cents?: string | null; total_cents: number; updated_at?: string | null; user_id?: string | null }
      ...
      product_variants: {
        ...
        Insert: { compare_at_price_cents?: string | null; created_at?: string | null; id?: string; is_active?: boolean | null; name: string; option_values?: Json | null; price_cents: number; product_id: string; sku?: string | null; stock_qty?: number | null; updated_at?: string | null }
        Update: { compare_at_price_cents?: string | null; created_at?: string | null; id?: string; is_active?: boolean | null; name?: string; option_values?: Json | null; price_cents?: number; product_id?: string; sku?: string | null; stock_qty?: number | null; updated_at?: string | null }
      ...
      products: {
        ...
        Insert: { barcode?: string | null; brand_id: string; category_id: string; compare_at_price_cents?: string | null; created_at?: string | null; description?: string | null; dimensions?: string | null; how_to_use?: string | null; id?: string; ingredients?: string | null; is_active?: boolean | null; is_featured?: boolean | null; key_benefits?: string[] | null; low_stock_threshold?: number | null; name: string; price_cents: number; search_vector?: unknown; sku?: string | null; slug: string; stock_qty?: number | null; tagline?: string | null; updated_at?: string | null; weight_grams?: number | null }
